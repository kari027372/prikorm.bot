...
// Основано на рекомендациях WHO, ESPGHAN, AAP, NHS, CDC
...
const PRODUCTS = [
    ...
    // Латинская Америка
    { id:'plantain', name:'Плантан (зелёный банан)', cat:'овощ', min_age:6, iron:false, allergen:false, choking:false, texture:{6:'пюре',8:'размятое',10:'кусочки'}, desc:'Варить или запекать.' },
    ...
    // ============================================================
    // 13. ГОТОВЫЕ ПРОДУКТЫ (детское питание) — бренды не указываем
    // ============================================================
