...
/* ============================================================
   БАЗОВЫЕ ПРОДУКТЫ С ОСОБЫМ РИСКОМ (ДОПОЛНЕНО)
   ============================================================ */
...
/* ============================================================
   ПРОДУКТЫ, КОТОРЫЕ НУЖНО ИЗМЕНЯТЬ ПО ФОРМЕ (ДОПОЛНЕНО)
   ============================================================ */
...
const FORM_DEPENDENT_PRODUCTS = {
    ...
    "виноград": {
        ...
        unsafeForms: ["целый"] // добавлено явно
    },
    ...
    "яблоко": {
        ...
        unsafeForms: ["сырое твёрдое яблоко"] // добавлено явно
    },
