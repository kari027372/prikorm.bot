...
(function () {
  ...
  // Данные загружаются из data/products.js
  ...
  function renderProducts(state) {
    const child = typeof window.getCurrentChild === 'function'
      ? window.getCurrentChild(state)
      : null;
    ...
    if (searchQuery.trim()) {
      ...
      filtered = filtered.filter(function (p) {
        return (
          ...
          (p.interestingFact &&
            p.interestingFact.toLowerCase().includes(q))
        );
      });
    }
      ...
      <div class="screen products-screen">
        ...
        <div class="products-filters">
          ...
          ${CATEGORIES.map(function (cat) {
            return `
              <button
                class="filter-btn ${currentCategory === cat.id ? 'active' : ''}"
          ...
          ${
            filtered.length === 0
              ...
              : filtered.map(function (product) {
                  ...
                  const ageOk =
                    childAgeMonths >= product.introduction.fromMonths;
        ...
        <div class="disclaimer">
          ...
          При наличии аллергии или сомнений
  ...
  // ============================================================
  // Глобальный API для существующего приложения
  // ============================================================
